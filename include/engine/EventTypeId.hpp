...
/// Use this in event header files
#define FUG_DECLARE_EVENT_TEMPLATES(EVENT_TYPE)\
    extern template int64_t fug::EventTypeId::typeId<EVENT_TYPE>();

/// Use this in event source files
#define FUG_DEFINE_EVENT_TEMPLATES(EVENT_TYPE)\
    template int64_t fug::EventTypeId::typeId<EVENT_TYPE>();
