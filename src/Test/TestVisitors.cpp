...
bool TestVisitor1::operator()(TestComponent1& component)
{
    component.a++;
    component.b--;
    printf("TestVisitor1, TestComponent1[%llu]: [%d, %d]\n", component._entityId, component.a, component.b);
    return true;
}
                              ...
                              TestComponent2& component2)
{
    ...
    component2.a += 1.0f;
    component2.b -= 1.0f;
    printf("TestVisitor2, TestComponent1[%llu]: [%d, %d]\n", component1._entityId, component1.a, component1.b);
    printf("TestVisitor2, TestComponent2[%llu]: [%0.2f, %0.2f]\n", component2._entityId, component2.a, component2.b);
    return true;
}
