...
bool TestVisitor1::operator()(TestComponent1& component)
{
    ...
    printf("TestVisitor1, TestComponent1[%llu]: [%d, %d]\n",
           (unsigned long long)component._entityId, component.a, component.b);
    return true;
}
                              ...
                              TestComponent2& component2)
{
    ...
    printf("TestVisitor2, TestComponent1[%llu]: [%d, %d]\n",
           (unsigned long long)component1._entityId, component1.a, component1.b);
    printf("TestVisitor2, TestComponent2[%llu]: [%0.2f, %0.2f]\n",
           (unsigned long long)component2._entityId, component2.a, component2.b);
    return true;
}
                              ...
                              TestComponent3& component3)
{
    ...
    printf("TestVisitor3, TestComponent3[%llu]: [%0.2f, %0.2f]\n",
           (unsigned long long)component3._entityId, component3.a, component3.b);
    return true;
}
